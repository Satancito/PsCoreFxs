...
Set-GlobalConstant -Name "__PSCOREFXS_ANDROID_NDK_X64_ABI" -Value "x86_64"
Set-GlobalConstant -Name "__PSCOREFXS_ANDROID_NDK_ARM_ABI_NORMALIZED" -Value "armeabi-v7a"
Set-GlobalConstant -Name "__PSCOREFXS_ANDROID_NDK_ARM64_ABI_NORMALIZED" -Value "arm64-v8a"
Set-GlobalConstant -Name "__PSCOREFXS_ANDROID_NDK_X86_ABI_NORMALIZED" -Value "x86"
Set-GlobalConstant -Name "__PSCOREFXS_ANDROID_NDK_X64_ABI_NORMALIZED" -Value "x86_64"
